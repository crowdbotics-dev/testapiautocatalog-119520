...
## Project Structure
    ...
    ├── testapiautocatalog_119520  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_119520`
...
2. Clone this repo and `cd testapiautocatalog_119520`
